...
export default function LoA() {
  ...
  return (
    <div style={{ padding: '40px', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ height: '50px' }}>
          <img src={logo} alt="University of Staffordshire" 
          style={{ 
            height: '100%', 
            objectFit: 'contain' 
            }} />
      ...
      <div style={{
        ...
        <div style={{ height: '50px' }}>
          <img src={anniversaryLogo} alt="20 Years of Games" style={{ height: '100%', objectFit: 'contain' }} />
        </div>

        <a href="https://www.staffs.ac.uk/go/games" target="_blank" rel="noreferrer" style={{
          fontFamily: 'Arial Black, Gadget, sans-serif',
          color: 'white',
          fontSize: '20px',
          textDecoration: 'none'
        ...
        <div style={{ height: '50px' }}>
          <img src={SUlogo} alt="Staffs Logo" style={{ height: '100%', objectFit: 'contain' }} />
        </div>
      </div>
    </div>
  );
